...
type
  ...
  /// <summary> **
  ///<p> * 滚动hash法 </p>
  ///<p> * 对目标字符串按d进制求值,mod h 取余作为其hash  </p>
  ///<p> * 对源串,依次求出m个字符的hash,保存在数组中(滚动计算) </p>
  ///<p> * 匹配时,只需比对目标串的hash值和预存的源串的hash值表  </p>
  ///<p> * </p>
  /// </summary>
  ...
  private
    ...
    class function __hash(s: UString): int64; overload;
    // **
    // * subStringLen是子串的长度
