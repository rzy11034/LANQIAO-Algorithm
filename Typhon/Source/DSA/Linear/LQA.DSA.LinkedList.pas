...
type
  ...
  public type
    ...
    public
      constructor Create;
      constructor Create(e: T; Next: TNode = nil);
...
constructor TLinkedList.TNode.Create(e: T; Next: TNode);
begin
  _E := e;
  _Next := Next;
end;
...
begin
  ...
  while cur <> nil do
  begin
    if TImpl.TCmp.Default.Compare(cur.E, e) = 0 then
      Exit(true);
...
begin
  ...
  begin
    ...
    if TImpl.TCmp.Default.Compare(del.E, e) = 0 then
    begin
      prev.Next := del.Next;
      _size -= 1;
      FreeAndNil(del);
