...
constructor THeap.Create(const arr: TArr; cmp: ICmp; heapKind: THeapkind);
var
  i: integer;
begin
  _cmp := cmp;
...
constructor THeap.Create(const arr: TArr; heapKind: THeapkind);
begin
